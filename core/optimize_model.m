function [results] = optimize_model(y, k, model_type, options)
    ...
    % If we want to fix rho (only when testing exogeneity)
    fix_rho_val = [];
    ...
    % We use try-catch in case of critical problems
    try
        ...
        % Robust standard errors for significance tests
